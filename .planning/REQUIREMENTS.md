...
- [ ] **RADR-02**: LLMService uses movie-context prompt when normalizing Radarr search results
- [ ] **RADR-03**: LLM cache keys include media_type to prevent TV/movie collisions
...
| RADR-02 | Phase 2 | Pending |
| RADR-03 | Phase 2 | Pending |
